...
def get_args_ant():
    ...
    parser.add_argument('--hi-buffer-size', type=int, default=int(1e5), help='the size of the buffer')
    ...
    parser.add_argument("--update_phi_times", type=int, default=50000)
    parser.add_argument("--reset_buffer_interval", type=int, default=100)
    ...
    #representation
    parser.add_argument('--latent_dim', type=int, default=2, help="number of landmarks")
    parser.add_argument('--coverage_ratio', type=float, default=0.6, help="coverage ratio")
    parser.add_argument('--obs2ld_eps', type=float, default=-0.01, help="coverage ratio")
