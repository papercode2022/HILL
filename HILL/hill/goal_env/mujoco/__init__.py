...
task_types = ['Maze', 'Maze1', 'Push', 'Fall', 'BlockMaze']
...
for name_t in all_name:
    ...
    for Test in ['', 'Test', 'Test1', 'Test2']:
        ...
        #     kwargs={'env_name': name_t, 'goal_args': goal_args, 'maze_size_scaling': 8, 'random_start': True,
        ...
        register(
            id=name_t + Test + '-v1',
            entry_point='goal_env.mujoco.create_maze_env:create_maze_env',
            kwargs={'env_name': name_t, 'goal_args': goal_args, 'maze_size_scaling': 4, 'random_start': True,
                    "fix_goal": fix_goal, "top_down_view": top_down, 'test':Test},
            max_episode_steps=max_timestep,
        )
        ...
        register(
            id=name_t + Test + '-v2',
            entry_point='goal_env.mujoco.create_maze_env:create_maze_env',
            kwargs={'env_name': name_t, 'goal_args': goal_args, 'maze_size_scaling': 2, 'random_start': True,
                    "fix_goal": fix_goal, "top_down_view": top_down, 'test':Test},
            max_episode_steps=max_timestep,
        )

        # v3 is the fix start env
        register(
            id=name_t + Test + '-v3',
            entry_point='goal_env.mujoco.create_maze_env:create_maze_env',
            kwargs={'env_name': name_t, 'goal_args': goal_args, 'maze_size_scaling': 4, 'random_start': False,
                    "fix_goal": True, "top_down_view": top_down, 'test':Test},
            max_episode_steps=max_timestep,
        )
        ...
        register(
            id=name_t + Test + '-v4',
            entry_point='goal_env.mujoco.create_maze_env:create_maze_env',
            kwargs={'env_name': name_t, 'goal_args': goal_args, 'maze_size_scaling': 2, 'random_start': False,
                    "fix_goal": True, "top_down_view": top_down, 'test':Test},
            max_episode_steps=max_timestep,
        )
